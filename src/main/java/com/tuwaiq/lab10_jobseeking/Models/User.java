...
public class User {
    ...
    private Integer id;
    @NotEmpty(message = "Sorry, the user id can't be empty, please try again")
    @Size(min = 4, max = 20,message = "Sorry, the user id can't be less than 4 or longer than 20 characters long, please try again")
    @Pattern(regexp = "^[a-zA-Z*$]", message = "Sorry, the user id can only contain alphabet, please try again")
    ...
    @Column(columnDefinition = "varchar(11) not null check(role='EMPLOYER') or (role='JOB_SEEKER')")
    private String role;
}
